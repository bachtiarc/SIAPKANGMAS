            ...
            <div class="min-w-[1350px]">
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-50/70 backdrop-blur sticky top-0 z-10">
                        <tr>
                            <th class="px-4 py-4 text-xs font-bold text-gray-600 uppercase tracking-wider border-b border-gray-200/70 text-center whitespace-nowrap min-w-[170px]">Nomor Tiket</th>
