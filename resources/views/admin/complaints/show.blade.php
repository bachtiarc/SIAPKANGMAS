...
@php
    ...
    $badgeColor = match(true) {
        ...
        in_array($statusRaw, ['completed','selesai'])                                    => 'bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200',
    ...
    $statusDot = match(true) {
        ...
        in_array($statusRaw, ['completed','selesai'])                                    => 'bg-emerald-500',
    ...
    $timelineItems->push(['title' => 'Tiket Dibuat oleh Pemohon', 'time' => $complaint->created_at, 'note' => null]);
    $timelineItems->push(['title' => 'Tiket Diterima Sistem', 'time' => $complaint->created_at, 'note' => null]);
...
<div class="space-y-5">
                    ...
                    <div class="min-w-0">
                        <div class="flex items-center gap-3 flex-wrap">
                            <h1 class="font-montserrat text-xl font-bold text-gray-900">
                                Detail Pengaduan
                                <span class="text-blue-700">{{ $ticketNo }}</span>
                            </h1>
                        ...
                        <div class="flex items-center gap-4 mt-2 text-xs text-gray-500 flex-wrap">
                            <span class="inline-flex items-center gap-1.5">
                                ...
                                Diajukan {{ optional($complaint->created_at)->format('d F Y') }}
                            </span>
            ...
            <div class="overflow-x-auto">
                <div class="min-w-[860px]">
                    @php
                        ...
                        $defaultNotes = [
                            0 => 'Pengaduan berhasil diajukan dan masuk ke dalam sistem.',
                            1 => 'Tiket terdaftar dan siap diproses oleh tim admin.',
                        ];
                        ...
                        <div class="flex justify-between items-start">
                            @foreach($timelineItems as $i => $it)
                                @php
                                    ...
                                    if (empty($noteVal)) {
                                        if (isset($defaultNotes[$i])) $noteVal = $defaultNotes[$i];
                                        elseif ($isActive) $noteVal = $defaultNoteActive;
                                    }
    ...
    <div class="section-card">
        <div class="section-header">
            ...
            <span class="section-title">Isi Pengaduan</span>
        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
                <div class="lg:col-span-8 space-y-4">
                    ...
                    <div class="card p-4">
                        <p class="field-label">Judul Pengaduan</p>
                    ...
                    <div class="lg:col-span-5">
                        <div class="card p-4 h-full flex flex-col">
                            ...
                            <textarea name="admin_notes"
                                      class="scrollbar-thin flex-1 w-full px-3 py-3 border border-gray-200 rounded-xl text-sm text-gray-800 bg-gray-50 focus:bg-white focus:border-blue-400 focus:ring focus:ring-blue-50 placeholder-gray-400 resize-none transition"
                                      style="min-height:200px"
                                      placeholder="Tuliskan catatan atau respons kepada pemohon...">{{ $complaint->admin_response ?? $complaint->admin_notes }}</textarea>
...
{{-- Modal Konfirmasi --}}
<div id="saveModalComplaint" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden items-center justify-center z-50 p-4">
    <div class="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="p-5 flex gap-3">
            <button type="button" onclick="closeSaveModalComplaint()" class="btn-outline flex-1 justify-center">Batal</button>
            <button type="button" onclick="submitComplaintFollowup()" class="btn-primary flex-1 justify-center">
                Ya, Simpan
            </button>
        </div>
    </div>
