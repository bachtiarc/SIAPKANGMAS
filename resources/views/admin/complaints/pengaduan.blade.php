{{-- resources/views/admin/complaints/pengaduan.blade.php --}}
                ...
                <div class="overflow-x-auto">
                    <div class="min-w-max flex items-end gap-4">
                        ...
                        <div class="shrink-0 flex items-center gap-2 ml-2">
                            ...
                            <a href="{{ route('admin.complaints.pengaduan') }}" class="px-4 py-2 border border-blue-600/80 text-blue-700 text-sm font-semibold rounded-2xl hover:bg-blue-50/70 transition shadow-sm bg-white/70 whitespace-nowrap active:scale-[.99]">Reset</a>
