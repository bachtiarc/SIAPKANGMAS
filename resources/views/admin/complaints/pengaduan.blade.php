...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        {{-- Tab Navigation (Round + Full Width) --}}
                ...
                <div class="overflow-x-auto">
                    <div class="min-w-max flex items-end gap-4">
                        ...
                        <div class="shrink-0 flex items-center gap-2 ml-2">
                            ...
                            <a href="{{ route('admin.complaints.pengaduan') }}" class="px-4 py-2 border border-blue-600 text-blue-600 text-sm font-medium rounded-lg hover:bg-blue-50 transition shadow-sm bg-white whitespace-nowrap">Reset</a>
