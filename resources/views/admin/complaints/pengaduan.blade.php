                ...
                <div class="overflow-x-auto">
                    <div class="min-w-max flex items-end gap-4">
                        ...
                        <div class="shrink-0 flex items-center gap-2 ml-2">
                            ...
                            <a href="{{ route('admin.complaints.pengaduan') }}" class="inline-flex items-center gap-1.5 px-4 py-2 border border-gray-200 text-gray-600 text-sm font-semibold rounded-xl hover:bg-gray-50 active:scale-[.98] transition-all bg-white whitespace-nowrap">
                                Reset
                            </a>
                            <a href="{{ route('admin.management.export', ['tab' => 'pengaduan'] + request()->query()) }}"
            ...
            <div class="min-w-[1200px]">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100/70">
                        ...
                        @empty
                        <tr>
                            <td colspan="9" class="p-10 text-center text-gray-500">Data pengaduan tidak ditemukan.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
