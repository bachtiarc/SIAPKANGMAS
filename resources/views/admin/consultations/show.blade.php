...
@php
    ...
    $timelineItems->push(['title' => 'Tiket Dibuat oleh Pemohon', 'time' => $consultation->created_at, 'note' => null]);
    $timelineItems->push(['title' => 'Tiket Diterima Sistem', 'time' => $consultation->created_at, 'note' => null]);
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-4 mt-2 text-xs text-gray-500 flex-wrap">
                            <span class="inline-flex items-center gap-1.5">
                                ...
                                Diajukan {{ optional($consultation->created_at)->format('d F Y') }}
                            </span>
            ...
            <div class="overflow-x-auto">
                <div class="min-w-[860px]">
                    @php
                        ...
                        $defaultNotes = [
                            0 => 'Permohonan konsultasi berhasil diajukan dan masuk ke dalam sistem.',
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
                <div class="lg:col-span-8 space-y-4">
                    ...
                    <div class="card p-4">
                        <p class="field-label">Judul Konsultasi</p>
                    ...
                    <div class="lg:col-span-5">
                        <div class="card p-4 h-full flex flex-col">
                            ...
                            <textarea name="admin_notes"
                                      ...
                                      placeholder="Tuliskan catatan atau respons kepada pemohon...">{{ $consultation->admin_response ?? $consultation->admin_notes }}</textarea>
...
{{-- Modal Konfirmasi --}}
<div id="saveModalConsultation" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden items-center justify-center z-50 p-4">
    <div class="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="p-5 flex gap-3">
            <button type="button" onclick="closeSaveModalConsultation()" class="btn-outline flex-1 justify-center">Batal</button>
            <button type="button" onclick="submitConsultationFollowup()" class="btn-primary flex-1 justify-center">
                Ya, Simpan
            </button>
        </div>
    </div>
