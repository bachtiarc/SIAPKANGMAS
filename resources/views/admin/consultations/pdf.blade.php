...
<h1>DETAIL PENGAJUAN KONSULTASI</h1>

<p><b>No Tiket</b> : {{ $consultation->ticket_id }}</p>
<p><b>Status</b> : {{ ucfirst($consultation->status) }}</p>
<p><b>Tanggal Pengajuan</b> : {{ $consultation->created_at->format('d F Y') }}</p>
