    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div class="bg-white/75 backdrop-blur-xl p-6 rounded-3xl shadow-sm border border-gray-200/70 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
            <div class="w-10 h-10 bg-yellow-50/80 ring-1 ring-yellow-200/60 rounded-2xl flex items-center justify-center mb-4">
                <svg class="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>
            </div>
                ...
                <div class="overflow-x-auto">
                    <div class="min-w-max flex items-end gap-4">
                        ...
                        <div class="shrink-0 flex items-center gap-2 ml-2">
                            ...
                            <a href="{{ route('admin.consultations.konsultasi') }}" class="inline-flex items-center gap-1.5 px-4 py-2 border border-gray-200 text-gray-600 text-sm font-semibold rounded-xl hover:bg-gray-50 active:scale-[.98] transition-all bg-white whitespace-nowrap">
                                Reset
                            </a>
            ...
            <div class="min-w-[1200px]">
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-50/70 backdrop-blur sticky top-0 z-10">
                        <tr>
                            <th class="px-4 py-4 text-xs font-bold text-gray-600 uppercase tracking-wider border-b border-gray-200/70 text-center whitespace-nowrap min-w-[160px]">Nomor Tiket</th>
                    ...
                    <tbody class="divide-y divide-gray-100/70">
                        ...
                        <tr class="hover:bg-gray-50/70 transition">
                            ...
                            <td class="px-4 py-4 text-center whitespace-nowrap">
                                ...
                                @endphp
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold {{ $statusClass }} ring-1 ring-black/5">{{ $statusLabel }}</span>
                            </td>
                                    ...
                                    @if($canArchive)
                                        <form method="POST" action="{{ route('admin.consultations.archive', $item->id) }}" class="inline">
                                            ...
                                            <button type="button"
                                                    ...
                                                    title="Arsipkan"
                                                    data-action="{{ route('admin.consultations.archive', $item->id) }}">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
