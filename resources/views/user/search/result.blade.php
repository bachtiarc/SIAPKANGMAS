...
<div class="p-6">
    ...
    <div class="mb-6">
        <a href="{{ route('user.dashboard') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 mb-4 font-lato">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <div class="space-y-3">
            @foreach($submissions as $i)
                <a href="{{ route('user.submissions.show', $i->id) }}?from=search&q={{ urlencode($q) }}" class="block border border-gray-200 p-4 rounded-lg hover:border-blue-500 hover:shadow-md transition">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <div class="space-y-3">
            @foreach($consultations as $i)
                <a href="{{ route('user.consultations.show', $i->id) }}?from=search&q={{ urlencode($q) }}" class="block border border-gray-200 p-4 rounded-lg hover:border-green-500 hover:shadow-md transition">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-2">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <div class="space-y-3">
            @foreach($complaints as $i)
                <a href="{{ route('user.complaints.show', $i->id) }}?from=search&q={{ urlencode($q) }}" class="block border border-gray-200 p-4 rounded-lg hover:border-purple-500 hover:shadow-md transition">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-2">
                                <span class="text-xs text-gray-500 font-mono font-lato">{{ $i->ticket_number }}</span>
