                ...
                <div class="flex flex-col items-center" style="width: 33%;">
                    ...
                    <div class="text-center">
                        ...
                        @if($complaint->completed_at)
                            <p class="text-xs text-gray-500 mt-1">{{ $complaint->completed_at->format('d M Y, H:i') }}</p>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                @if($complaint->admin_notes && $complaint->admin_notes != $complaint->admin_response)
                <div class="mb-6">
                    <label class="block text-sm font-semibold text-gray-600 mb-2">Catatan Admin</label>
                    <div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-lg">
                        <p class="text-gray-900">{{ $complaint->admin_notes }}</p>
                    </div>
                </div>
                @endif

                @if($complaint->handler && !$complaint->admin_response)
                <div class="mb-6">
