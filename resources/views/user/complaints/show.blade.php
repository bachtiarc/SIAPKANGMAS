...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('user.complaints.download', $complaint) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative flex justify-between">
                ...
                <div class="flex flex-col items-center" style="width: 25%;">
                    ...
                    <div class="text-center">
                        <p class="font-semibold text-gray-900 text-sm">Pengaduan Terkirim</p>
                        <p class="text-xs text-gray-500 mt-1">{{ $complaint->created_at->format('d M Y, H:i') }}</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center" style="width: 25%;">
                    ...
                    <div class="text-center">
                        ...
                        @if($isCompleted && $complaint->completed_at)
                            <p class="text-xs text-green-600 mt-1">{{ $complaint->completed_at->format('d M Y, H:i') }}</p>
                        @elseif($isRejected && $complaint->completed_at)
                            <p class="text-xs text-red-600 mt-1">{{ $complaint->completed_at->format('d M Y, H:i') }}</p>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-8 mb-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-600 mb-2">Kategori Pengaduan</label>
                            ...
                            @foreach($complaint->documents as $doc)
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <!-- Download Button -->
                                        <a href="{{ route('user.complaints.document.download', $doc) }}" class="text-blue-600 hover:text-blue-800" title="Download">
                                        ...
                                        <!-- View Button -->
                                        <a href="{{ route('user.complaints.documents.view', $doc) }}" target="_blank" class="text-blue-600 hover:text-blue-800" title="Lihat">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Riwayat Aktivitas -->
    @if(isset($complaint->statusHistories) && $complaint->statusHistories->count() > 0)
