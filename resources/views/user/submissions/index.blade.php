...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        ...
        <div class="mt-4 flex items-center space-x-2">
            ...
            <a href="{{ route('user.submissions.index', array_filter(['status' => 'diproses', 'search' => request('search')])) }}" 
            ...
            <a href="{{ route('user.submissions.index', array_filter(['status' => 'selesai', 'search' => request('search')])) }}" 
            ...
            <a href="{{ route('user.submissions.index', array_filter(['status' => 'ditolak', 'search' => request('search')])) }}" 
