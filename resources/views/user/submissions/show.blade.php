...
@section('title', 'Detail Permohonan - ' . $submission->ticket_number)
    ...
    <div class="bg-white rounded-lg shadow-sm p-8 mb-6">
        ...
        <div class="relative">
            ...
            @php
                ...
                if (in_array($statusLower, ['on_progress', 'diproses', 'in_progress'])) {
                    $progressWidth = '50%';
            ...
            <div class="relative flex justify-between">
                ...
                <div class="flex flex-col items-center" style="width: 33%;">
                    @php
                        $isProcessing = in_array($statusLower, ['pending', 'on_progress', 'diproses', 'in_progress']);
                        $isFinished = in_array($statusLower, ['completed', 'selesai', 'rejected', 'ditolak']);
                    @endphp
                    ...
                    <div class="text-center">
                        ...
                        @elseif(in_array($statusLower, ['on_progress', 'diproses', 'in_progress']))
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                <div class="mb-6">
                    ...
                    <p class="text-gray-900">{{ $submission->information_title }}</p>
                </div>

                <div class="mb-6">
                    <label class="block text-sm font-semibold text-gray-600 mb-2">Deskripsi Lengkap</label>
                    <p class="text-gray-900 whitespace-pre-line">{{ $submission->information_purpose }}</p>
                </div>
            ...
            <div>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <p class="text-gray-900 whitespace-pre-line">{{ $submission->admin_response }}</p>
                ...
                @if($submission->admin_notes && $submission->admin_notes != $submission->admin_response)
                <div class="mb-6">
                ...
                @if($submission->handler && !$submission->admin_response)
                <div class="mb-6">
