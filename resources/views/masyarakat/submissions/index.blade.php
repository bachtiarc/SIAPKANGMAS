...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <!-- Create Button -->
            <a href="{{ route('masyarakat.submissions.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
        ...
        <div class="mt-4 flex items-center space-x-2">
            ...
            <a href="{{ route('masyarakat.submissions.index') }}" class="px-3 py-1 rounded-lg text-sm {{ !request('status') || request('status') == 'semua' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                Semua
            </a>
            <a href="{{ route('masyarakat.submissions.index', ['status' => 'pending']) }}" class="px-3 py-1 rounded-lg text-sm {{ request('status') == 'pending' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                Diproses
            </a>
            <a href="{{ route('masyarakat.submissions.index', ['status' => 'completed']) }}" class="px-3 py-1 rounded-lg text-sm {{ request('status') == 'completed' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                Selesai
            </a>
            <a href="{{ route('masyarakat.submissions.index', ['status' => 'rejected']) }}" class="px-3 py-1 rounded-lg text-sm {{ request('status') == 'rejected' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                Ditolak
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="{{ route('masyarakat.submissions.show', $submission->id) }}" class="text-blue-600 hover:text-blue-800">
        ...
        @else
            <div class="text-center py-12">
                ...
                <div class="mt-6">
                    <a href="{{ route('masyarakat.submissions.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                        Buat Pengajuan Baru
                    </a>
                </div>
            </div>
