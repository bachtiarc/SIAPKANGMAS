...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <!-- Search -->
            <form method="GET" action="{{ route('masyarakat.submissions.index') }}" class="flex space-x-2">
                @if(request('status'))
                ...
                @if(request('search'))
                    <a href="{{ route('masyarakat.submissions.index', request('status') ? ['status' => request('status')] : []) }}" 
        ...
        <div class="mt-4 flex items-center space-x-2">
            ...
            <a href="{{ route('masyarakat.submissions.index', request('search') ? ['search' => request('search')] : []) }}" 
            ...
            <a href="{{ route('masyarakat.submissions.index', array_filter(['status' => 'selesai', 'search' => request('search')])) }}" 
            ...
            <a href="{{ route('masyarakat.submissions.index', array_filter(['status' => 'ditolak', 'search' => request('search')])) }}" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="{{ route('masyarakat.submissions.show', $submission->id) }}?from=index" class="text-blue-600 hover:text-blue-800">
