...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <!-- Create Button -->
            <a href="{{ route('masyarakat.consultations.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="{{ route('masyarakat.consultations.show', $consultation->id) }}?from=index" class="text-blue-600 hover:text-blue-800">
        ...
        @else
            <div class="text-center py-12">
                ...
                <div class="mt-6">
                    <a href="{{ route('masyarakat.consultations.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
