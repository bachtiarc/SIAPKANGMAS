            ...
            <div class="flex items-start justify-between">
                ...
                <div class="flex-1">
                    ...
                    <p class="font-lato text-gray-600 max-w-2xl">
                        Selamat datang di SIAPKANGMAS (Sistem Aplikasi Konsultasi, Pengaduan, & Permohonan Informasi DISPERINDAG). Anda memiliki <strong>{{ $totalSubmissions }} pengajuan</strong> yang sedang dalam proses verifikasi.
                    </p>
                </div>
                ...
                <div class="ml-6 bg-gray-50 rounded-lg p-4 min-w-[240px]">
                    <div class="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            ...
                            <p class="font-lato text-xs text-gray-600">Masyarakat Umum</p>
                            <p class="font-lato text-xs text-gray-500"></p>
                        </div>
                    </div>
                    <a href="{{ route('masyarakat.profile') }}" class="font-montserrat text-xs text-blue-600 hover:text-blue-700 font-medium underline">Lihat Profil Lengkap Pengguna</a>
                </div>
            </div>
        </div>
