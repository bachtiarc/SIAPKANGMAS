...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <!-- Create Button -->
            <a href="{{ route('masyarakat.complaints.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
            ...
            <form method="GET" action="{{ route('masyarakat.complaints.index') }}" class="flex space-x-2">
                ...
                @if(request('search'))
                    <a href="{{ route('masyarakat.complaints.index', request('status') ? ['status' => request('status')] : []) }}" 
        ...
        <div class="mt-4 flex items-center space-x-2">
            ...
            <a href="{{ route('masyarakat.complaints.index', request('search') ? ['search' => request('search')] : []) }}" 
            ...
            <a href="{{ route('masyarakat.complaints.index', array_filter(['status' => 'pending', 'search' => request('search')])) }}" 
            ...
            <a href="{{ route('masyarakat.complaints.index', array_filter(['status' => 'diproses', 'search' => request('search')])) }}" 
            ...
            <a href="{{ route('masyarakat.complaints.index', array_filter(['status' => 'selesai', 'search' => request('search')])) }}" 
            ...
            <a href="{{ route('masyarakat.complaints.index', array_filter(['status' => 'ditolak', 'search' => request('search')])) }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="{{ route('masyarakat.complaints.show', $complaint->id) }}?from=index" class="text-blue-600 hover:text-blue-800">
        ...
        @else
            <div class="text-center py-12">
                ...
                <div class="mt-6">
                    <a href="{{ route('masyarakat.complaints.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                        Buat Pengaduan Baru
                    </a>
                </div>
            </div>
