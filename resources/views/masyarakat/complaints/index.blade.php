...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <!-- Create Button -->
            <a href="{{ route('masyarakat.complaints.create', ['from' => 'index']) }}"
            ...
            <form method="GET" action="{{ route('masyarakat.complaints.index') }}" class="flex space-x-2">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nomor tiket atau subjek.."
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="{{ route('masyarakat.complaints.show', $complaint->id) }}?from=index"
