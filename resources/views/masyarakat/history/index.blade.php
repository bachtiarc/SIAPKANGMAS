            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <a href="{{ route('masyarakat.history.index', array_filter(['search' => request('search'), 'status' => request('status')])) }}" 
                        ...
                        <a href="{{ route('masyarakat.history.index', array_filter(['category' => 'submission', 'search' => request('search'), 'status' => request('status')])) }}" 
                        ...
                        <a href="{{ route('masyarakat.history.index', array_filter(['category' => 'consultation', 'search' => request('search'), 'status' => request('status')])) }}" 
                        ...
                        <a href="{{ route('masyarakat.history.index', array_filter(['category' => 'complaint', 'search' => request('search'), 'status' => request('status')])) }}" 
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <a href="{{ route('masyarakat.history.index', array_filter(['search' => request('search'), 'category' => request('category')])) }}" 
                        ...
                        <a href="{{ route('masyarakat.history.index', array_filter(['status' => 'pending', 'search' => request('search'), 'category' => request('category')])) }}" 
                        ...
                        <a href="{{ route('masyarakat.history.index', array_filter(['status' => 'diproses', 'search' => request('search'), 'category' => request('category')])) }}" 
                        ...
                        <a href="{{ route('masyarakat.history.index', array_filter(['status' => 'selesai', 'search' => request('search'), 'category' => request('category')])) }}" 
                        ...
                        <a href="{{ route('masyarakat.history.index', array_filter(['status' => 'ditolak', 'search' => request('search'), 'category' => request('category')])) }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        @else
            <div class="text-center py-12">
                ...
                @if(request('search') || request('category') || request('status'))
                <div class="mt-6">
                    <a href="{{ route('masyarakat.history.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                        Reset Filter
                    </a>
                </div>
                @endif
